...
#   $ python3 schiff.py spy:///dev/pts/5 -2
#                     anstatt 5 muss vl ein anderer Port hin (die verbundenen Ports verden nach  socat aufruf ausgegeben)

# in another terminal start a player 1 instace and let them play 1000 games
#   $ python3 schiff.py spy:///dev/pts/4 -r -t2 -l1
#     ein game
#     python3 schiff.py spy:///dev/pts/4 -s -t2 -l1
#   
#  zum runnen   python.exe .\schiff.py spy://COM3 -s

#               python.exe .\schiff.py spy://COM3 -s -2
